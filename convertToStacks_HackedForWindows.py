...
def convert_to_HDF5(
        ...
        compression=None, skip_bad_files=False):
    ...
    for cur_dir, folders, files in os.walk(directory):
        ...
        for cycle in cycles:
            for idx, (protocol, reps) in enumerate(protocol_elements):
                output_filename = '{}_Cycle{:05d}_Element{:05d}.h5'.format(
                    basename, cycle + 1, idx + 1)
        ...
        failed = False
        for output_filename, (tiffs, channels) in tiffs_to_save.iteritems():
...
if __name__ == '__main__':
    ...
    convert_to_HDF5(
        ...
        compression=args.compression, skip_bad_files=args.skip)
